...
import 'package:today/json/task_bean.dart';
import 'package:today/json/task_icon_bean.dart';
import 'package:today/model/all_model.dart';
import 'package:today/pages/all_page.dart';
...
class ProviderConfig {
  ...
  ChangeNotifierProvider<TaskDetailPageModel> getTaskDetailPage(
    int index,
    TaskBean taskBean, {
    required DoneTaskPageModel doneTaskPageModel,
    required SearchPageModel searchPageModel,
  }) {
